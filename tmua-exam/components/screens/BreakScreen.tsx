...
export default function Paper2InstructionsScreen({
  ...
  return (
    <main className="max-w-5xl mx-auto">
      <div className="mb-4 text-lg font-semibold">Review complete. Paper 2 starts next.</div>
      ...
      <p className="mb-3 text-sm">
        You are about to proceed to Paper 2. You cannot return to Paper 1 after this point.
      </p>
