...
import { STEP_MANIFEST, formatBytes, groupMaterials, uniqueYears } from '@/lib/admissions-library'

export const metadata = {
  title: 'STEP Papers and Solutions',
  description: 'Local STEP library with papers, solutions, reports, hints, specifications, and formula booklets downloaded from Physics & Maths Tutor.',
}

export default function StepPage() {
  const groups = groupMaterials(STEP_MANIFEST.items)
  const years = uniqueYears(STEP_MANIFEST.items)
        ...
        <RevealOnScroll>
          <section className="warm-card rounded-[2rem] p-7 md:p-9">
            ...
            <h1 className="mt-4 max-w-5xl text-3xl font-black tracking-tight text-slate-900 md:text-5xl">
              Local STEP papers, solutions, reports, and supporting documents.
            </h1>
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-600 md:text-lg">
              All files on the Physics & Maths Tutor STEP page have been downloaded into the local app and exposed here as a structured library.
            </p>
            <div className="mt-6 grid gap-3 md:grid-cols-3">
              <div className="warm-card-muted rounded-2xl p-4">
                ...
                <div className="mt-2 text-3xl font-black text-slate-900">{STEP_MANIFEST.count}</div>
              </div>
              <div className="warm-card-muted rounded-2xl p-4">
              ...
              <div className="warm-card-muted rounded-2xl p-4">
                ...
                <div className="mt-2 text-3xl font-black text-slate-900">{formatBytes(STEP_MANIFEST.totalBytes)}</div>
              </div>
            </div>
          </section>
        </RevealOnScroll>
